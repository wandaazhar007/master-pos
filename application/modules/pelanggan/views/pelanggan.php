                  ...
                  <ul class="menu-list">
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li class="active"><a href="datatable_responsive.html">Responsive data tables</a></li>
                      </ul>
                    </li>
                  </ul>
                </div>
  ...
  <div class="page-header">
    <div class="page-header-content">
      <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Datatables</span> - Responsive</h4>

        <ul class="breadcrumb breadcrumb-caret position-right">
          <li><a href="index.html">Home</a></li>
          <li><a href="datatable_responsive.html">Datatables</a></li>
